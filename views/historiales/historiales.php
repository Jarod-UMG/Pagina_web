			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						<li class="nav-item">
							<a href="vistas.php?c=historiales&a=nuevo" class="btn btn-primary">Agregar</a>
						</li>
					</ul>
				...
				<table border="2" id="myTable" width="80%" class="table table-white table-hover table-striped">
					...
					<tbody>
						<?php                  
							...
							echo "<td><a href='vistas.php?c=historiales&a=modificar&id=".$dato["id_historial"]."' class='btn btn-warning'>Modificar</a></td>";
							echo "<td><a href='vistas.php?c=historiales&a=eliminar&id=".$dato["id_historial"]."' class='btn btn-danger' onclick=\"return confirm('Esta seguro de elimiar el registro?');\">Eliminar</a></td>";
							echo "</tr>";
						}
						?>
					</tbody>
